...
public class Tianjiaview {//添加学生
	...
	public static void tianview()
	{
		JFrame jf4=new JFrame("添加学生信息");
			...
			public void actionPerformed(ActionEvent e) {
				...
				else
				{
					try
					{
						...
						PreparedStatement ps=con.prepareStatement("insert into studentinfor(no,name,sex,idcard,banji,major,school) values(?,?,?,?,?,?,?)");
						...
						ps.setString(6, jt6.getText().toString().trim());
						ps.setString(7, jt7.getText().toString().trim());
						ps.executeUpdate();
